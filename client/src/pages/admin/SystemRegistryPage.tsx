...
export default function SystemRegistryPage() {
  ...
  if (isLoading) {
    return <div className="p-8">Loading full registry...</div>;
  }

  const allUsersRaw = data?.items || [];
  ...
  const paginatedUsers = allUsers.slice(startIndex, startIndex + entriesPerPage);
    ...
    <div className="p-6 max-w-[100vw] overflow-x-hidden">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-1">A complete overview of every registered account on the platform.</p>
        </div>
      </div>
                    ...
                    <tr key={user.id} className="bg-white border-b border-gray-200 hover:bg-gray-50">
                      ...
                      <td className="px-2 py-2 border-r border-gray-200 text-center">
                        <div className="flex justify-center gap-1">
                          <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-200 font-medium">Registry</Badge>
                        </div>
                      </td>
                      <td className="px-2 py-2 border-r border-gray-200 text-center">
